...
export default function RoleManagerTableHead({
  ...
  function label(key: RoleSortKey, text: string) {
    return (
      <TableSortLabel
        active={sortKey === key}
  ...
  return (
    <TableHead>
      <TableRow>
        ...
        <TableCell align="center">{label('isAdmin', t('roleTableAdmin'))}</TableCell>
        <TableCell align="center">{label('isEmployee', t('roleTableEmployee'))}</TableCell>
        <TableCell align="center">
          {label('canCreateCart', t('roleTableCanCreateCart'))}
        </TableCell>
        <TableCell align="center">
          {label('canOrderProducts', t('roleTableCanOrderProducts'))}
        </TableCell>
